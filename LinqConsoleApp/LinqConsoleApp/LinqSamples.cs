...
namespace LinqConsoleApp
{
    public class LinqSamples
    {
        ...
        */
        ...
        {
            var res = Emps.OrderByDescending(emp => emp.Salary).Take(1);
        }
        ...
        {
            var res = Emps.GroupBy(emp => emp.Job).Count();
        }
        ...
        {
            var res = Emps.Where(emp => emp.Job == "Backend programmer").FirstOrDefault();
        }
